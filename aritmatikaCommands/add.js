  ...
  execute(message, args) {
    ...
    if (args.length !== 2) {
      const embedError = new EmbedBuilder()
        .setColor('#FF0000')
        .setTitle('Error')
        .setDescription('Harap berikan dua nilai untuk ditambahkan.')
    ...
    if (isNaN(value1) || isNaN(value2)) {
      const embedError = new EmbedBuilder()
        .setColor('#FF0000')
        .setTitle('Error')
        .setDescription('Harap berikan nilai numerik yang valid untuk ditambahkan.')
      return message.reply({ embeds: [embedError] });
    }
    ...
    const embed = new EmbedBuilder()
      .setColor('#FFFFFF')
      .setTitle('Kalkulator Pertambahan')
